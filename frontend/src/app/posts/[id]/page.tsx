...
function VoteButton({ direction, onClick, isActive }: { direction: 'up' | 'down', onClick: () => void, isActive?: boolean }) {
  ...
  const buttonClass = `p-2 rounded-md transition-colors duration-200 ${isActive ? (direction === 'up' ? 'text-[#FF9E3D] bg-orange-100' : 'text-blue-600 bg-blue-100') : 'text-gray-400 hover:bg-gray-100'}`;
  return (
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href={`/?category=${category}`} className="text-lg font-semibold text-gray-700 hover:text-[#FF9E3D]">
              ...
              <div className="flex-1">
                ...
                {post.category === 'GENERAL' ? (
                  ...
                  <div className="space-y-6">
                    <div>
                      <h2 className="text-xl font-semibold text-[#FF9E3D] mb-2">What failed?</h2>
                      <p className="text-gray-700 leading-relaxed">{post.whatFailed}</p>
                    </div>
                    <div>
                      <h2 className="text-xl font-semibold text-[#44BBA4] mb-2">What did you learn?</h2>
          ...
          <div className="border-t border-gray-200 px-8 py-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="bg-[#FF9E3D] hover:bg-[#FF8C1A] text-black px-4 py-2 rounded-md text-sm font-medium transition-colors"
              >
                Write a comment
              </button>
            </div>
